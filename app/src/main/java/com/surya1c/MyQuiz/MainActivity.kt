...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList.add(QuestionModel("Which animal is known as the 'Ship of the Desert?","Cow","Lion","Camel"," Snake","Camel"))
        questionsList.add(QuestionModel(" How many days are there in a week?","5 Days","6 Days","7 Days","8 Days","7 Days"))
        questionsList.add(QuestionModel("What is the main component of the sun?","Liquid lava","Gas","Molten iron","Rock","Gas"))
        questionsList.add(QuestionModel("What is the pH value of the human body?","7 to 7.8","5.3 to 5.9","6.2 to 6.6","3.4 to 4","7 to 7.8"))
